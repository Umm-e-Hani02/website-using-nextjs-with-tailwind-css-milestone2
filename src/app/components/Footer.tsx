...
export default function Footer(){
    return(
        <footer className="bg-fuchsia-950 h-44">
            ...
            <div className="flex justify-center items-center gap-1 text-nowrap sm:gap-2">
                <p className="text-sm md:text-lg font-semibold text-gray-400">Powered by <span className="underline text-white cursor-pointer hover:text-gray-200">UMM-E-HANI</span></p>
                <span>|</span>
