        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center space-x-4">
              <Link href="/" className="text-white rounded-lg p-2 active:opacity-5 transition-all">Home</Link>
              <Link href="/about" className="text-white rounded-lg p-2 active:opacity-5 transition-all">About</Link>
              <Link href="/menu" className="text-white rounded-lg p-2 active:opacity-5 transition-all">Menu</Link>
              <Link href="/contact" className="text-white rounded-lg p-2 active:opacity-5 transition-all">Contact</Link>
              <Link href="/feedback" className="text-white rounded-lg p-2 active:opacity-5 transition-all">Feedback</Link>
            </div>
          </div>
